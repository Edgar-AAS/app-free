...
class Assets {
    ...
    static var bannerHome: UIImage {
        resource(name: "bannerHome")
    }
    ...
    static var servicePlumber: UIImage? {
        resource(name: "servicePlumber")
    }

    static var seviceElectrician: UIImage? {
        resource(name: "seviceElectrician")
    }

    static var iconStar: UIImage? {
        resource(name:  "iconStar")
    }
