...
class Strings {
    ...
    static var discount30: String {
        getStringForKey("discount30")
    }
    
    static var bookingHomeServices: String {
        getStringForKey("Just by Booking Home Services")
    }
    
    static var serviceProviders: String {
        getStringForKey("Service Providers")
    }
    
    static var visualizeAll: String {
        getStringForKey("Ver tudo")
    }
    
    static var maskotKota: String {
        getStringForKey("Maskot Kota")
    }
    
    static var plumber: String {
        getStringForKey("Plumber")
    }
    
    static var shamsJan: String {
        getStringForKey("Shams Jan")
    }
    
    static var electrician: String {
        getStringForKey("Electrician")
    }
    
    static var rating4_8: String {
        getStringForKey("4.8")
    }
    
    static var details: String {
        getStringForKey("Details")
    }
    
    static var detailsOf: String {
        getStringForKey("detailsOf")
    }
